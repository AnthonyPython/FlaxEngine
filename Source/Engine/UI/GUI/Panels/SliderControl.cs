...
namespace FlaxEngine.GUI
{
    ...
    /// </summary>
    public class SliderControlGUI : ContainerControl
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SliderControlGUI"/> class.
        /// </summary>
        ...
        public SliderControlGUI(float value, float x = 0, float y = 0, float width = 120, float min = float.MinValue, float max = float.MaxValue)
